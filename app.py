...
def random_flake_api():
    ...
    if request.method == 'POST':
        options = ast.literal_eval(request.data.decode('UTF-8')) # convert the data imported in a binary format to a dictionary (part in brackets converts to a string, ast_lit.. part converts string rep of dictionary to dictionary
        #print(request.data)
        print(options)
        #print(type(options))
